...
author: "Margaret Nagawa" # Remember to add your name!
date: "16-10-2024"
theme: united
format: html
---
...
cantril_wider<-pivot_wider(cantril_filter,names_from = Year,values_from = "Cantril ladder score") 

view(cantril_wider)

hap_table<-cantril_wider %>% select(Country,`2011`,`2023`)%>% 
...
# Create line chart
cantril_filter<-cantril %>% 
filter(Country %in% c("Uganda","Ghana","Iran", "Indonesia","Guinea"))
       
       
hp_plot<-ggplot(cantril_filter,aes(x= Year,y=`Cantril ladder score`,col=Country))+
  geom_line()+
  scale_y_continuous(limits = c(0,10))+
  labs(title="line Graph showing happiness for selected countries",x="year",y="Cantril Ladder Score")+
  theme_minimal()
